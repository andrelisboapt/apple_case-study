...
<div className="carousel carousel-center p-1 space-x-1">
  ...
  <div className="card card-compact cardProducts ml-2 bg-base-100 shadow-xl rounded-none">
   <figure><img src={highlight1} alt="Apple iPad Pro (M2)" /></figure> 
...
<p className='actionText'>Comparar</p>
  ...
  <div className="card card-compact cardProducts ml-2 bg-base-100 shadow-xl rounded-none">
   <figure><img src={highlight2} alt="Apple iPad Pro (M2)" /></figure> 
  <div className="carousel-item">
...
<p className='actionText'>Comparar</p>
  ...
  <div className="card card-compact cardProducts ml-2 bg-base-100 shadow-xl rounded-none">
   <figure><img src={highlight3} alt="Apple iPad Pro (M2)" /></figure> 
  <div className="carousel-item">
...
<p className='actionText'>Comparar</p>
  ...
  <div className="card card-compact cardProducts ml-2 bg-base-100 shadow-xl rounded-none">
   <figure><img src={highlight4} alt="Apple iPad Pro (M2)" /></figure> 
  <div className="carousel-item">
...
<p className='actionText'>Comparar</p>
  ...
  <div className="card card-compact cardProducts ml-2 bg-base-100 shadow-xl rounded-none" style={{ clipPath: 'polygon(0 0, 100% 0, 50% 0%, 50% 100%, 0 100%)' }}>
   <figure><img src={highlight5} alt="Apple iPad Pro (M2)" /></figure> 
  <div className="carousel-item">
